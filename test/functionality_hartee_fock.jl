...
rhf_be_321g = run_problem("./data/integrals_be_321g.hdf5)", true)
@test rhf_be_321g["energies"]["total"] ≈ -14.4868202421763 atol=1e-10

uhf_be_321g = run_problem("./data/integrals_be_321g.hdf5)", false)
@test uhf_be_321g["energies"]["total"] ≈ -14.4868202421763 atol=1e-10

rohf_c_321g = run_problem("./data/integrals_c_321g.hdf5)", true)
@test rohf_c_321g["energies"]["total"] ≈ -37.4803888099046 atol=1e-10

uhf_c_321g = run_problem("./data/integrals_c_321g.hdf5)", false)
@test rohf_c_321g["energies"]["total"] ≈ -37.4810698325847 atol=1e-10
