...
"""
function compute_next_iterate(acc::Union{Accelerator, Void}, iterate::ScfIterState)
	return iterate
end
...
"""
function postprocess_iterate(acc::Union{Accelerator, Void}, iterate::ScfIterState)
	return iterate
end
